...
function validatpopupemail() {
  ...
  if (!pattern1.test($('#email-popup').val())) {
   ...
   $('.banner').before('<div class="alert alert-success"><i class="fa fa-check-circle"></i> Đăng ký thành công <button type="button" class="close" data-dismiss="alert">&times;</button></div>');
      return false;
  }
}
(function ($) {
...
$.fn.firstVisitPopup = function (settings) {
  ...
  var hideMessage = function () {
      ...
      let checked = $("#checkme").is(":checked");
      if(checked){
